...
async function fetchMovieWithId(id) {
    const url = `https://api.themoviedb.org/3/movie/${id}?api_key=16d9a92a7d891f66d6d444278a7aa7b1`
    ...
    try {
        ...
        const options = {
            ...
            headers: {
              ...
              Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIxNmQ5YTkyYTdkODkxZjY2ZDZkNDQ0Mjc4YTdhYTdiMSIsInN1YiI6IjY0OGZkOGEzMjYzNDYyMDBhZTFjYWIxMCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.Ed9LoUdGqHVXWNW3aLn_udd3URbH6kG5BFo8beMo2yk'
            }
          };
...
async function searchMovies(movieName) {
    try {
        ...
        const url = `https://api.themoviedb.org/3/search/movie?query=${movieName}&api_key=16d9a92a7d891f66d6d444278a7aa7b1`
